      ...
      <main className="w-full max-w-md">
              ...
              return (
                ...
                >
                  <button 
                    ...
                    className={`absolute top-6 right-6 w-11 h-11 rounded-full flex items-center justify-center z-50 transition-all duration-700 shadow-sm border ${
                      isUpdating 
        ...
        {appState === AppState.PRACTICING && (
          <div className="flex flex-col items-center w-full mt-4">
             <button onClick={() => { stopMic(); setAppState(AppState.SELECTING_SENTENCE); }} className="self-start text-slate-500 text-[12px] font-black mb-6 uppercase tracking-widest">← Back to list</button>
             <div className="bg-white rounded-[40px] p-8 w-full shadow-xl text-center relative border border-slate-50">
                <div className={`text-[15px] font-black text-slate-400 tracking-widest uppercase mb-8 ${isListening ? 'text-red-500 animate-pulse' : isCompleted ? 'text-emerald-600' : 'text-slate-300'}`}>
